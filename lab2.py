...
while True:
    if f == 1:
        print()
        print("Введите код математической операции с матрицей (матрицами), введите -1 для перехода к вычислениям с помощью библиотеки numpy или введите любое другое целое число для выхода из программы:")
        print()
    ...
    if o == 1:
        while True:
            ...
            if n < 1:
                print()
                print("Ошибка! Длина строки (количество столбцов) не может быть меньше 1.")
                print()
                continue
        ...
        while True:
            ...
            if len(a) % n != 0:
                ...
                if len(a) != n:
                    print()
                    print("Ошибка! Вычисление обратной матрицы невозможно, поскольку заданная матрица не является квадратной.")
                    if f == -1:
                        o = -1
                    break
                else:
                    if f == 1 and (n == 2 or n == 3):
                        if det(a) != 0:
                            a = inverse(a)
                            print()
                            for i in range(len(a)):
                            ...
                            print()
                            print("Ошибка! Вычисление обратной матрицы невозможно, поскольку определитель заданной матрицы равен нулю.")
                            break
                    elif f == 1:
                        print()
        ...
        print()
        print("Введите код математической операции с матрицей (матрицами), введите -1, чтобы вернуться обратно, или введите любое другое целое число для выхода из программы.")
        print()
        o = int(input("Код операции: "))
        if o < -1 or o == 0 or o > 4:
            break
